          ...
          <div className="contact-social-email">
            <span>
              <svg
                ...
                class="lucide lucide-mail w-7 h-7 text-red-600"
                aria-hidden="true"
              >
          ...
          <div className="contact-social-instagram">
            <span>
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="lucide lucide-instagram w-7 h-7 text-pink-600"
                aria-hidden="true"
              >
          ...
          <div className="contact-social-telegram">
            <span>
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="lucide lucide-send w-7 h-7 text-blue-600"
                aria-hidden="true"
              >
          ...
          <div className="contact-social-phone">
            <span>
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="lucide lucide-phone w-7 h-7 text-green-600"
                aria-hidden="true"
              >
