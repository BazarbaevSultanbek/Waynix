...
export default function MedicalCard({ item }) {
  const isOpen = getIsOpen(item.hours);

  return (
    <Card radius="lg" withBorder shadow="sm" className="medical-card">
      <Card.Section className="medical-card__media">
        <Image src={item.image} height={220} alt={item.name} />
        <Group className="medical-card__stars" gap={5}>
      ...
      <Group mt="md" grow>
        <Button
          ...
          className="medical-card__call-btn"
        >
          Qo'ng'iroq
        </Button>
