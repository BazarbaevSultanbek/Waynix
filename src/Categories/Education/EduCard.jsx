...
export default function EducationCard({ item }) {
  ...
  return (
    <Card radius="lg" withBorder shadow="sm" className="edu-card">
      <Card.Section className="edu-card__media">
        <Image src={item.image} height={220} alt={item.name} />
        <Group className="edu-card__stars" gap={5}>
